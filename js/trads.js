...
'fr':
	{ 
		...
		grid_choose:		'ou choisissez le carroyage qui vous convient:',
		perso_size_between: 	'Entrez une taille de carré personnalisée (entre ',
		and:			'et',
...
'en':
	{ 
		...
		grid_choose:		'or choose the grid that suits you:',
		perso_size_between: 	'Indicate a square size (between ',
		and:			'and',
...
'nl':
	{ 
		...
		grid_choose:		'of kies de rooster die u past:',
		perso_size_between: 	'Voer een gepersonaliseerde vierkant breedte in (tussen ',
		and:			'en',
