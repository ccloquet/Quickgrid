...
L.Control.EasyButton = L.Control.extend({
  ...
  initialize: function(icon, onClick, title, position){	// position : modified by CHR

    if (position == null) position = 'topleft';		// added by CHR
	...
	this.options.position = position;				// added by CHR
      // turn the options object into a state
      this.options.states.push({
        icon: icon,
	//position: position,						// added by CHR
        onClick: onClick,
